...
class InfractionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create infraction" do
    assert_difference('Infraction.count') do
      post infractions_url, params: { infraction: { date: @infraction.date, hour: @infraction.hour, value: @infraction.value } }
    end
  ...
  test "should update infraction" do
    patch infraction_url(@infraction), params: { infraction: { date: @infraction.date, hour: @infraction.hour, value: @infraction.value } }
